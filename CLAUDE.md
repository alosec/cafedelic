...
1. Use the gh command with body-file function
2. Save comment content in: `docs/issues/<issue-num-and-name>/comment-<description>.md`
3. Create directory structure as needed: `docs/issues/`
4. Example workflow:
   ```bash
   # Create issue directory
   mkdir -p docs/issues/10-review-implementation

   # Write comment to file
   cat > docs/issues/10-review-implementation/comment-final-approval.md << 'EOF'
   Comment content here...
   EOF

   # Post comment using gh
   gh issue comment 10 --body-file docs/issues/10-review-implementation/comment-final-approval.md
   ```
